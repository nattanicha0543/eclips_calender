...
class TC5_1_SearchID {
	...
	void TC101() throws InterruptedException {
	    ...
	    driver.findElement(By.name("search")).sendKeys("614259012");
	...
	void TC102() throws InterruptedException {
	    ...
	    driver.manage().window().setSize(new Dimension(1020, 824));
	    driver.findElement(By.name("search")).click();
	    driver.findElement(By.name("search")).sendKeys("614259045");
	    driver.findElement(By.name("search")).sendKeys(Keys.ENTER);
	...
	void TC103() throws InterruptedException {
	    ...
	    driver.manage().window().setSize(new Dimension(1020, 824));
	    driver.findElement(By.name("search")).click();
	    driver.findElement(By.name("search")).sendKeys("614259010");
	    driver.findElement(By.name("search")).sendKeys(Keys.ENTER);
